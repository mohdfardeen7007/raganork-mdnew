...
const baseConfig = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '918127875972-1632403322@g.us',
    ...
    RG: process.env.RG || '918127875972-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://i.ibb.co/B598wrtG/raganork-bot.png;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
